...
namespace SpedService.Model
{
    ...
    public class SpedFiscalDAL
    {
        ...
        public void GerarBloco0()
        {
            ...
            consultaSql = "from ViewSpedNfeEmitenteDTO emitente where Id in (select cab.Fornecedor.Id from NfeCabecalhoDTO as cab where cab.DataEmissao BETWEEN " + Biblioteca.QuotedStr(DataInicial) + " and " + Biblioteca.QuotedStr(DataFinal) + ")";
            ...
            consultaSql = "from ViewSpedNfeDestinatarioDTO destinatario where Id in (select cab.Cliente.Id from NfeCabecalhoDTO as cab where cab.DataEmissao BETWEEN " + Biblioteca.QuotedStr(DataInicial) + " and " + Biblioteca.QuotedStr(DataFinal) + ")";
            ...
            consultaSql = "from ViewSpedNfeItemDTO item where Id in (select det.Produto.Id from NfeDetalheDTO as det inner join det.NfeCabecalho as cab where cab.DataEmissao BETWEEN " + Biblioteca.QuotedStr(DataInicial) + " and " + Biblioteca.QuotedStr(DataFinal) + ")";
        ...
        public void GerarBlocoC()
        {
            ...
            consultaSql = "from NfeCabecalhoDTO where DataEmissao BETWEEN " + Biblioteca.QuotedStr(DataInicial) + " and " + Biblioteca.QuotedStr(DataFinal);
            ...
            if (PerfilApresentacao == 0)
            {
                if (ListaNFeCabecalho != null)
                {
                    foreach (NfeCabecalhoDTO NFeCabecalho in ListaNFeCabecalho)
                    {
                        ...
                        consultaSql = "from NfeCupomFiscalReferenciadoDTO where NfeCabecalho.Id = " + NFeCabecalho.Id;
                        IList<NfeCupomFiscalReferenciadoDTO> ListaCupomNFe = new NHibernateDAL<NfeCupomFiscalReferenciadoDTO>(session).selectListaSql<NfeCupomFiscalReferenciadoDTO>(consultaSql);
        ...
        public void GerarBlocoE()
        {
            ...
            consultaSql = "from FiscalApuracaoIcmsDTO where Competencia=" + System.DateTime.Parse(DataInicial).ToString("MM/yyyy");
