...
namespace CadastrosBaseService.Model {
    ...
    public class ColaboradorDTO {
        ...
        public TipoAdmissaoDTO TipoAdmissao { get; set; }
        public SituacaoColaboradorDTO SituacaoColaborador { get; set; }
        public PessoaDTO Pessoa { get; set; }
        public TipoColaboradorDTO TipoColaborador { get; set; }
        public NivelFormacaoDTO NivelFormacao { get; set; }
